...
> Reference copy of the ralph-tools skill that Ralph Orchestrator auto-injects
> when tasks or memories are enabled.
> Source: `ralph-core/data/ralph-tools.md`.
>
> Injected wrapped in `<ralph-tools-skill>` XML tags during orchestration.
